...
public class DMASpinnerEstadosProyectosSinDenuncia extends AsyncTask<String, Void, String> {
    ...
    //Constructor
    public DMASpinnerEstadosProyectosSinDenuncia(Spinner spin, Context ct)
    {
    ...
    protected String doInBackground(String... urls) {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM ESTADOS_PROYECTO WHERE ESTADO NOT LIKE '%DENUNCIADO%'");
            result2 = " ";
