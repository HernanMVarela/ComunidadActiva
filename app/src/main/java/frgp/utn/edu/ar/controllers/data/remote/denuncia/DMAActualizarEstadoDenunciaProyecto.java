...
public class DMAActualizarEstadoDenunciaProyecto extends AsyncTask<String, Void, Boolean> {
    private Denuncia modificar;
    public DMAActualizarEstadoDenunciaProyecto(Denuncia modificar) {
    ...
    protected Boolean doInBackground(String... strings) {
        ...
        try {
            ...
            String query = "UPDATE DENUNCIAS_PROYECTOS SET ID_ESTADO = ? WHERE ID_PROYECTO = ?";
