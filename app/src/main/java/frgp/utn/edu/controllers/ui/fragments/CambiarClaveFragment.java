...
import frgp.utn.edu.controllers.ui.viewmodels.CambiarClaveViewModel;
...
public class CambiarClaveFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final TextView textView = binding.textCambiarClave;
        cambiarClaveViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
        return root;
    }
